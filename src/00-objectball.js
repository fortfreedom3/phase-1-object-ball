...
//     this.home = "Brooklyn Nets";
//     this.away = "Charlotte Hornets";
// };
...
const game = gameObject();
  ...
  function numPointsScored(playerName) {
      ...
      for (const gameKey in game) {
        const teamInfo = game[gameKey];
          //colors, players, teamName 
          for (const teamKey in teamInfo) {
              const playersObject = teamInfo.players
              //player data 
              for (const playerKey in playersObject) {
                  if (playerKey === playerName) {
                      return playersObject[playerKey].points
                  }
              }
          }
      }
...
//               for (const playerKey in playersObject) {
//                   if (playerKey === playerName) {
//                       return playersObject[playerKey].shoe
//                   }
//               }
//           }
//       }
